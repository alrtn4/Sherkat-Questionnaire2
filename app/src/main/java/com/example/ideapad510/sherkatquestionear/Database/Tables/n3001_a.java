...
public class n3001_a {
    public static final String TABLE_NAME = "n3001_a";
    ...
    public n3001_a(String acode, String atype, String apos , String aqoute, String afunc, String agoto , String ascour, int id) {
        this.id = id;
        this.Acode = acode;
        this.Atype = atype;
        this.Apos = apos;
