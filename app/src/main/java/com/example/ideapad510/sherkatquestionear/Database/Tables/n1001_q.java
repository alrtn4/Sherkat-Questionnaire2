...
public class n1001_q {
    public static final String TABLE_NAME = "n1001_q";
    ...
    public n1001_q(String Qcode, String Qtype, String Qpos , String Qqoute, String Qfunc, String Qgoto , String Qscour, int id) {
        this.id = id;
        this.Qcode = Qcode;
        this.Qtype = Qtype;
        this.Qpos = Qpos;
